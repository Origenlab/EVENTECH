...
coordinates:
  lat: 19.4401
  lng: -99.2044
googleMapsUrl: "https://maps.google.com/?q=Museo+Soumaya+Plaza+Carso"
...
gallery:
  - "/images/venues/soumaya-interior.jpg"
  - "/images/venues/soumaya-evento.jpg"
  - "/images/venues/soumaya-noche.jpg"
  - "/images/venues/soumaya-plaza.jpg"
...
## Arte y Arquitectura Como Escenario de Tu Evento

El Museo Soumaya no es solo un museo: es una **declaración arquitectónica que ha transformado el skyline de la Ciudad de México**. Diseñado por el arquitecto Fernando Romero (yerno de Carlos Slim), este edificio de 17,000 metros cuadrados está cubierto por 16,000 hexágonos de aluminio que crean una superficie orgánica única en el mundo —un "monumento al arte" que en sí mismo es una obra de arte.
...
Los invitados a eventos en el Museo Soumaya tienen el privilegio de experimentar una de las **colecciones de arte más importantes del mundo privado**:

- **Auguste Rodin:** La colección más grande fuera de Francia
- **Salvador Dalí:** Obras maestras del surrealismo español
- **Diego Rivera, David Alfaro Siqueiros, Rufino Tamayo:** Lo mejor del muralismo mexicano
- **Arte Virreinal:** Pintura y escultura colonial de los siglos XVI-XVIII
- **Arte Prehispánico:** 30 siglos de cultura mesoamericana
- **Arte Europeo:** Del Greco a Van Gogh, de Picasso a Cézanne

## Producción de Eventos de Alto Nivel

El Museo Soumaya cuenta con **infraestructura profesional** para eventos de gran escala:

### Capacidades Técnicas
- **Energía:** Capacidad eléctrica para producción de conciertos
- **Rigging:** Puntos de anclaje estructural para iluminación y audio
- **Conectividad:** Fibra óptica de alta velocidad para streaming
- **Montacargas:** Acceso para equipo de producción pesado
- **Backstage:** Áreas de preparación para artistas y oradores

### Servicios de Producción
- **Project manager** del museo dedicado
- **Seguridad perimetral** y protocolo VIP
- **Coordinación con autoridades** para eventos masivos
- **Permisos** de cierre de vialidades incluidos
- **Limpieza especializada** de espacios de arte

## Catering y Gastronomía

El museo trabaja con **caterers certificados de alto nivel** que pueden ejecutar cualquier visión gastronómica:

- **Menús de autor** diseñados para complementar el arte
- **Estaciones interactivas** sin riesgo para las obras
- **Servicio impecable** con personal uniformado
- **Opciones sustentables** alineadas con la filosofía del museo
- **Maridajes de vino** con sommeliers certificados

## ¿Por Qué Elegir el Museo Soumaya?

### Arquitectura Icónica
El único edificio en México diseñado específicamente para **ser fotografiado desde cualquier ángulo** —tus fotos de evento serán instantáneamente reconocibles.

### Credibilidad Cultural
Asociar tu evento o marca con una **institución cultural de prestigio mundial** eleva la percepción de cualquier celebración.

### Exclusividad Absoluta
Eventos after-hours en el museo garantizan **privacidad total y experiencias únicas** que no pueden replicarse en ningún otro lugar.
...
- **ArchDaily Building of the Year** nominación
- **Tripadvisor Travelers' Choice**
- **Condé Nast Traveler** "Must-See Museums"
- **Lonely Planet** Top Museums Latin America
- Más de **2 millones de visitantes anuales**

## La Experiencia Museo Soumaya
...
- **[Iluminación arquitectónica](/servicios/iluminacion/arquitectonica/)** para realzar la fachada de hexágonos
- **[Mapping de proyección](/servicios/audiovisual/proyectores/mapping/)** sobre las superficies curvas
- **[Line array profesional](/servicios/audiovisual/sonido/line-array/)** para eventos masivos en plaza
- **[Pantallas LED modulares](/servicios/audiovisual/pantallas-led/videowall/)** integradas al diseño
