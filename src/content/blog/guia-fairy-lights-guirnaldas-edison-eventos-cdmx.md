---
title: "Fairy Lights y Guirnaldas Edison: Guía Técnica CDMX"
seoTitle: "Guía de Fairy Lights y Guirnaldas Edison en CDMX"
...
tags:
  ...
  - luces cálidas para bodas
  - canopy de luces
  - cielo estrellado boda
  - iluminación de jardín
  - iluminación eventos CDMX
keywords:
  - fairy lights para bodas CDMX
  - qué son los fairy lights
  - guirnaldas edison para eventos CDMX
  - renta de fairy lights CDMX
  - canopy de luces para boda CDMX
  - cuánto metraje de fairy lights necesito
  - iluminación decorativa cálida 2700K CDMX
  - cielo estrellado sobre pista de baile CDMX
relatedServices:
  - "iluminacion"
  - "carpas"
  - "mobiliario"
relatedEvents:
  ...
  - "corporativos"
relatedPosts:
  - "cuanto-cuesta-rentar-guirnaldas-cdmx-precios-2026"
  - "guia-iluminacion-eventos-arquitectonica-decorativa-escenario"
  - "eventech-renta-equipo-eventos-cdmx-guia-completa"
cta:
  label: "Cotiza tus fairy lights el mismo día"
  href: "/servicios/iluminacion/decorativa/fairy-lights/"
faqs:
  - question: "¿Cuál es la diferencia entre fairy lights y guirnaldas Edison?"
    answer: "Los fairy lights son cientos de micro-LED sobre un cable delgado y flexible que se doblan, entrelazan y cuelgan casi en cualquier parte; dan una luz de puntos finos, delicada, ideal para el efecto de cielo estrellado y para envolver follaje. Las guirnaldas Edison usan focos tipo bulbo más grandes, separados sobre un cable robusto tipo bistró; dan una luz cálida ámbar con el filamento vintage a la vista, perfecta para cruzar sobre una terraza o un jardín con aire europeo. Muchas bodas usan las dos: fairy lights en los detalles y Edison como techo de luz."
  - question: "¿Qué significa 2700K y por qué importa en una boda?"
    answer: "2700K son grados Kelvin, la unidad que mide la temperatura de color de la luz. 2700K es un blanco cálido dorado, el tono que la mayoría asocia con romántico y acogedor, y por eso es el más solicitado en bodas de CDMX. Una luz de 4000K o más se ve blanca y fría, más de oficina que de fiesta, y arruina el ambiente por bonito que sea el montaje. Al rentar, confirma que los fairy lights sean de 2700K blanco cálido si buscas ese efecto de calidez."
  - question: "¿Cómo sé cuántos metros de fairy lights necesito?"
    answer: "El metraje se calcula midiendo la superficie que quieres cubrir y la altura del techo o de los puntos de anclaje, no a ojo. Un techo de luces sobre una zona chica de comedor puede pedir 80 a 100 metros; una pista con cielo estrellado, otro tanto; un jardín completo entrelazado con canopy puede necesitar 400 metros o más. Los recorridos estándar van en tramos de 50, 100, 200 y 400 metros, y en la visita técnica se mide el venue para definir el número exacto."
  - question: "¿Los fairy lights se pueden instalar en un jardín al aire libre?"
    answer: "Sí, es uno de sus usos estrella, pero el equipo debe ser para exterior con clasificación IP apropiada para resistir humedad y lluvia ligera. Se instalan entrelazados en árboles y arbustos, como techo de luz entre postes o tendidos sobre la pista. Lo que hay que resolver desde antes son los puntos de anclaje verificados y la energía, porque muchos jardines no tienen tomas de corriente cerca. Ante tormenta eléctrica se suspende la operación por seguridad, como con cualquier equipo conectado."
  - question: "¿Puedo controlar la intensidad de la luz durante el evento?"
    answer: "Sí, con un dimmer. La calidez de los fairy lights y las guirnaldas Edison se calibra con un atenuador que sube o baja la intensidad según el momento. Para la cena se suele dejar en un 40 a 60 por ciento, que da esa penumbra dorada y romántica; para las fotos o la entrada se sube, y para la fiesta se combina con el resto de la iluminación. Un montaje serio incluye dimmer y un técnico que ajusta la luz a lo largo de la noche."
  - question: "¿La instalación daña el venue o los árboles?"
    answer: "No, si se hace bien. Trabajamos con puntos de anclaje verificados: postes propios, cable de acero tensado, ganchos y sujeciones que no perforan ni marcan muros ni troncos. Antes de montar revisamos qué permite el venue y qué estructura hay disponible, y proponemos el sistema de sujeción adecuado. Un buen montaje se instala y se retira sin dejar rastro, y por eso conviene una visita técnica previa en venues delicados como haciendas o jardines con arbolado."
draft: false
---
...
Buenas noticias en energía: los fairy lights operan a **bajo voltaje** —12V o 24V vía transformador— así que consumen poco y son seguros al tacto, incluso cerca de tela o follaje. Las guirnaldas Edison suelen ir a 127V con cable comercial. Aun así, hay que tener **tomas de corriente** razonablemente cerca; en jardines y haciendas eso no siempre existe, y ahí entra una [planta de energía](/servicios/accesorios/plantas-energia/). Para exterior, el equipo debe tener clasificación **IP** adecuada (IP44 o superior) para aguantar humedad y lluvia ligera; un hilo de interior colgado en un jardín húmedo falla cuando menos lo esperas.

Esta es la tabla que resume lo que de verdad debes mirar:

| Especificación | Qué buscar | Por qué importa |
|---|---|---|
| **Temperatura de color** | 2700K blanco cálido (2200K en Edison) | Define si el ambiente se siente romántico o de oficina |
| **Tecnología** | Micro-LED (fairy) / filamento LED (Edison) | Puntos finos etéreos vs. focos con textura |
| **Metraje** | Tramos de 50 / 100 / 200 / 400 m | Es la unidad real; se calcula por superficie y altura |
| **Dimmer** | Incluido, con técnico | Ajusta la calidez por momento del evento |
| **Anclaje** | Puntos verificados, cable tensado | Evita cable combado y focos que se descuelgan |
| **Energía** | Bajo voltaje + toma o planta | Consumo modesto, pero el jardín necesita corriente |
| **Protección** | IP44+ para exterior | Aguanta humedad y lluvia ligera sin fallar |
...
| Criterio | Fairy lights | Guirnaldas Edison |
|---|---|---|
| **Efecto** | Puntos finos, cielo estrellado, etéreo | Focos con carácter, techo de luz cálida, rústico-chic |
| **Luz** | Blanco cálido 2700K, delicado | Ámbar 2200–2400K, con filamento a la vista |
| **Dónde brilla** | Follaje, cascada en tela, cielo sobre pista, detalles | Cruzado sobre terrazas, jardines y mesas largas |
| **Estilo** | Romántico, mágico, boho, "encantado" | Bistró europeo, industrial cálido, campestre |
| **Cable** | Delgado, casi invisible | Robusto, visible, parte del look |
...
| Montaje | Qué es | Metraje típico | Dónde luce |
|---|---|---|---|
| **Canopy de techo** | Líneas paralelas o cruzadas sobre el área, un "cielo de luz" | 100–400 m | Comedor y pista de jardines y terrazas |
| **Cascada sobre cortina de tela** | Hilos que caen sobre un drapeado, "muro de estrellas" | 50–120 m | Detrás del altar, presidium o mesa de novios |
| **Cielo estrellado sobre pista** | Puntos suspendidos que titilan sobre el baile | 80–200 m | Pista de baile de salón o jardín |
| **Entrelazadas en follaje** | Cable envuelto en árboles, setos y columnas verdes | 40–200 m | Jardines, accesos y muros verdes |
...
Puntos de luz **suspendidos y dispersos** sobre la pista de baile, más separados que en un canopy cerrado, para que titilen como estrellas reales sobre las cabezas. Convierte el momento del baile en algo íntimo y cinematográfico, sobre todo cuando se combina con el dimmer bajo y unas [esferas LED](/servicios/iluminacion/decorativa/esferas-led/) colgadas a distintas alturas.
...
| Recorrido | Superficie que cubre | Montaje típico |
|---|---|---|
| **50 m** | Un backdrop, un lounge, uno o dos árboles | Cascada sobre altar, foco decorativo, XV íntimo |
| **100 m** | Una zona de comedor o una pista media | Canopy chico o cielo estrellado, boda íntima |
| **200 m** | Comedor + pista o pista + follaje perimetral | Boda mediana de jardín, terraza corporativa |
| **400 m** | Salón o jardín completo, varias zonas | Boda de gala, producción de varias áreas |
...
4. **Olvidar la energía en jardín.** Muchos jardines y haciendas no tienen tomas de corriente cerca. Sin resolverlo, el techo de luz más bonito no enciende. Pregunta por la [planta de energía](/servicios/accesorios/plantas-energia/) desde la cotización.
...
6. **No pensar el resto de la ambientación.** Los fairy lights dejan el aire lleno de calidez, pero si los muros están planos y oscuros, falta una capa. Un poco de [uplighting](/servicios/iluminacion/arquitectonica/uplighting/) o unos [candiles](/servicios/iluminacion/decorativa/candiles/) completan el cuadro.
...
- **[Candiles](/servicios/iluminacion/decorativa/candiles/) y [esferas LED](/servicios/iluminacion/decorativa/esferas-led/):** volumen colgante a distintas alturas que dialoga con el canopy y le da profundidad al techo de luz.
- **[Letras luminosas](/servicios/iluminacion/decorativa/letras-luminosas/) y [neón vintage](/servicios/iluminacion/decorativa/neon-vintage/):** el mensaje —el nombre de la pareja, un "amor", un hashtag— que se roba las fotos sobre el fondo de estrellas.
- **[Cortinas de cascada LED](/servicios/iluminacion/decorativa/cascadas-led/):** para muros de estrellas de gran formato detrás de un escenario o un altar, cuando el metraje de fairy lights se queda corto para la superficie.
- **[Uplighting](/servicios/iluminacion/arquitectonica/uplighting/):** color en la base de los muros que sostiene el ambiente cuando la mirada baja del techo a las paredes.
- **[Carpas profesionales](/servicios/carpas/):** en jardín, la carpa es la estructura de la que cuelga el canopy y el seguro contra la lluvia; el techo de luz vive dentro de ella.
- **[Mobiliario](/servicios/mobiliario/) y [pistas de baile](/servicios/pistas-baile/):** el lounge y la pista son las zonas que la luz cálida vuelve fotografiables; se diseñan juntos.

Si quieres entender cómo encajan la iluminación decorativa, la arquitectónica y la de escenario en un mismo diseño, lo desarrollamos en la [guía maestra de iluminación para eventos](/blog/guia-iluminacion-eventos-arquitectonica-decorativa-escenario/). Y si estás armando el evento completo —no solo la luz—, la [guía de renta de equipo para eventos en CDMX](/blog/eventech-renta-equipo-eventos-cdmx-guia-completa/) te da el panorama de todo lo que se coordina en una sola logística.
...
Recuerda que son una capa aérea y cálida: brillan como techo de luz, cascada, cielo estrellado o follaje encantado, y se completan con [candiles](/servicios/iluminacion/decorativa/candiles/), [esferas LED](/servicios/iluminacion/decorativa/esferas-led/) y [uplighting](/servicios/iluminacion/arquitectonica/uplighting/) para un diseño con profundidad. Si ya tienes claro qué quieres y necesitas números, salta a [cuánto cuesta rentar guirnaldas en CDMX y sus precios 2026](/blog/cuanto-cuesta-rentar-guirnaldas-cdmx-precios-2026/), organizados por metraje. Y cuando quieras verlo en tu venue, arma tu montaje en [fairy lights](/servicios/iluminacion/decorativa/fairy-lights/) y [guirnaldas Edison](/servicios/iluminacion/guirnaldas/) o [cotiza directo](/cotizar/) y te devolvemos la propuesta el mismo día, con el metraje, el anclaje y el dimmer ya considerados.
