---
title: "Gobos y Proyección de Monogramas: Guía Técnica de Eventos"
seoTitle: "Gobos y Monogramas para Eventos CDMX: Guía Técnica 2026"
...
tags:
  - gobos para eventos
  - proyección de monogramas
  - monograma de novios
  - logo corporativo en luz
  - iluminación de escenario
  - proyector LED gobo
  - gobo personalizado
  - iluminación para bodas CDMX
keywords:
  - qué es un gobo para eventos CDMX
  - proyección de monograma de novios CDMX
  - gobo personalizado logo corporativo CDMX
  - gobo de metal vs vidrio eventos
  - cómo elegir gobo para boda CDMX
  - proyección de logo en muro evento CDMX
  - iluminación de monograma pista de baile CDMX
  - renta de proyector de gobos CDMX
relatedServices:
  - "iluminacion"
  - "audiovisual"
  - "pistas-baile"
relatedEvents:
  ...
  - "corporativos"
relatedPosts:
  - "cuanto-cuesta-rentar-gobos-monograma-cdmx-precios-2026"
...
faqs:
  - question: "¿Qué es exactamente un gobo?"
    answer: "Un gobo es una plantilla —una lámina de metal recortada o un cristal impreso— que se coloca dentro de un proyector, justo delante de la fuente de luz. Al pasar por esa plantilla, la luz sale con la forma recortada: un monograma, un logo, un patrón de estrellas o una textura. En pocas palabras, es la manera de proyectar un dibujo hecho de pura luz sobre el piso, un muro, el techo o una fachada."
  - question: "¿Cuál es la diferencia entre un gobo de metal y uno de vidrio?"
    answer: "El gobo de metal se corta en acero y proyecta en un solo color; es más económico, muy resistente y perfecto para monogramas, iniciales y logos de una tinta. El gobo de vidrio se fabrica con cristal dicroico y proyecta a todo color y con degradados, con mayor detalle y definición. La regla práctica es sencilla: si tu diseño es de un color, metal; si necesitas color o fotografía, vidrio."
  - question: "¿Puedo proyectar mi propio logo o el monograma de los novios?"
    answer: "Sí, es el uso más solicitado. Fabricamos un gobo a medida a partir de tu diseño en vectores (AI, EPS, SVG o PDF de alta resolución) y lo montamos en el proyector. Necesitamos alrededor de dos semanas de anticipación para fabricarlo. Si tu evento es antes de ese plazo, contamos con una biblioteca de gobos estándar de patrones y texturas disponibles de inmediato."
  - question: "¿Sobre qué superficies se ve bien un gobo?"
    answer: "Se proyecta mejor sobre superficies planas, claras y mate: piso de pista, muros lisos, techos y telones. Sobre superficies oscuras o muy texturizadas la imagen pierde intensidad y contraste. En la visita técnica revisamos el venue para elegir la superficie y la distancia que darán la proyección más nítida."
  - question: "¿De qué tamaño puede ser la proyección?"
    answer: "Con proyectores LED de 200 a 300 vatios logramos imágenes nítidas de entre uno y seis metros de diámetro. Entre más lejos se coloca el proyector, más grande resulta la imagen, aunque también más tenue. Para proyecciones de gran formato sobre muros o fachadas usamos varios proyectores de mayor potencia."
  - question: "¿El gobo se puede mover o cambiar de color durante el evento?"
    answer: "Sí. Con ruedas rotatorias el gobo gira para dar movimiento a un patrón, y con control DMX ajustamos la intensidad y encendemos o atenuamos la proyección según el momento. Para cambios de color y movimiento más dinámicos usamos cabezas móviles tipo spot, que integran gobos, color y posición motorizada en un solo aparato."
draft: false
---
...
Todo lo anterior se gobierna por **DMX 512**, el protocolo estándar de la iluminación profesional. Con DMX subimos y bajamos la intensidad (dimmer), activamos la rotación, sincronizamos varios proyectores y encendemos la proyección justo en el momento del vals y no antes. Si quieres profundizar en cómo se orquesta todo esto, lo explicamos en nuestra [guía maestra de iluminación para eventos](/blog/guia-iluminacion-eventos-arquitectonica-decorativa-escenario/).
...
- **[Cabezas móviles](/servicios/iluminacion/escenario/moving-heads/):** las tipo *spot* llevan gobos incorporados con ruedas rotatorias y color por DMX, ideales para gobos en movimiento durante el show.
- **[Par LED](/servicios/iluminacion/escenario/par-led/):** dan el color de base del ambiente; el gobo añade el detalle nítido encima.
- **[Follow spots](/servicios/iluminacion/escenario/follow-spots/):** siguen a las personas mientras el monograma vive en el piso.
- **[Sky trackers](/servicios/iluminacion/escenario/sky-tracker/):** para señalizar el evento desde el cielo en producciones grandes.
- **[Iluminación arquitectónica](/servicios/iluminacion/arquitectonica/):** wash y uplighting que visten muros mientras el gobo pone la marca.
- **[Pista de baile](/servicios/pistas-baile/):** el monograma cobra otra dimensión sobre una pista blanca o iluminada.

La idea es pensar en **capas**: base de color, detalle de gobo, dinamismo de movimiento y momentos de efecto. Cada una tiene su papel. El hub de [iluminación de escenario](/servicios/iluminacion/escenario/) reúne todas estas piezas para armar el show completo.
...
Cuando tengas claro qué quieres proyectar, revisa las configuraciones en la página de [gobos y proyección de monogramas](/servicios/iluminacion/escenario/gobos/) y salta al artículo hermano de [cuánto cuesta rentar gobos y monogramas en CDMX](/blog/cuanto-cuesta-rentar-gobos-monograma-cdmx-precios-2026/) para ponerle números a tu idea. ¿Ya tienes fecha y diseño? [Cotiza con nosotros](/cotizar/) y te devolvemos una propuesta con el tamaño, la distancia y el equipo exactos para tu venue.
