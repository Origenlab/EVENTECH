---
title: "Guía de Humo Bajo Ice Fog: el Baile en las Nubes en CDMX"
seoTitle: "Humo Bajo Ice Fog para Eventos CDMX | Guía 2026"
...
tags:
  - humo bajo eventos
  - ice fog primer baile
  - niebla a ras de piso
  - baile en las nubes bodas
  - hielo seco eventos CDMX
  - humo bajo para vals de XV
  - efectos especiales iluminación
  - efecto de niebla bodas
keywords:
  - qué es el humo bajo ice fog CDMX
  - efecto de niebla para primer baile CDMX
  - humo bajo que no activa detectores CDMX
  - renta de máquina de humo bajo bodas CDMX
  - hielo seco para baile en las nubes CDMX
  - humo bajo para vals de XV años CDMX
  - niebla a ras de piso para eventos CDMX
  - diferencia humo bajo y humo escénico CDMX
relatedServices:
  - "iluminacion"
  - "pistas-baile"
  - "audiovisual"
relatedEvents:
  ...
  - "corporativos"
relatedPosts:
  - "cuanto-cuesta-rentar-humo-bajo-cdmx-precios-2026"
  - "guia-iluminacion-eventos-arquitectonica-decorativa-escenario"
  - "eventech-renta-equipo-eventos-cdmx-guia-completa"
cta:
  label: "Cotiza tu efecto de humo bajo"
  href: "/servicios/iluminacion/efectos-especiales/humo-bajo/"
faqs:
  - question: "¿Qué es el humo bajo o ice fog?"
    answer: "El humo bajo, también llamado ice fog o niebla baja, es un efecto que genera una nube blanca y densa que se queda pegada al piso, a la altura de los tobillos, en lugar de subir y llenar el salón. Se logra enfriando el humo con hielo seco, con hielo común o con CO2, de modo que la niebla pesa más que el aire y se arrastra por el suelo. Es la nube sobre la que parecen bailar los novios en el primer baile."
  - question: "¿El humo bajo activa los detectores de humo del salón?"
    answer: "No. A diferencia de la máquina de humo escénico, que lanza vapor caliente que sube al techo y puede disparar los sensores, el humo bajo es frío y pesado, así que se queda a ras de piso y se disipa antes de llegar a los detectores. Por eso muchos salones y hoteles que prohíben la máquina de humo normal sí permiten el humo bajo. Aun así, siempre coordinamos con el venue antes del evento."
  - question: "¿El fluido del humo bajo es tóxico o daña la ropa?"
    answer: "No. Trabajamos con fluido de grado alimenticio, el mismo tipo que se usa en escenarios y estudios, que no es tóxico ni mancha la ropa ni el vestido. El efecto de hielo seco es agua y dióxido de carbono; se disipa dejando el aire limpio. La única precaución real es que la niebla enfría y humedece ligeramente el piso, así que cuidamos que la pista no quede resbalosa."
  - question: "¿Cuánto dura la nube de humo bajo?"
    answer: "Depende de la tecnología. Una carga de hielo seco produce una nube densa que dura entre dos y cuatro minutos, ideal para una canción, y luego se disipa. Los sistemas de humo bajo con hielo o de CO2 pueden mantener el efecto de forma continua o repetirlo varias veces durante el evento. Por eso el humo bajo se piensa por momentos, no como algo que llene toda la noche."
  - question: "¿Sobre qué piso funciona mejor el humo bajo?"
    answer: "Funciona mejor sobre una superficie plana, nivelada y sin corrientes de aire. Una pista de baile cerrada es el escenario ideal. El aire acondicionado, los ventiladores y las puertas abiertas dispersan la niebla y arruinan el efecto, así que coordinamos con el venue para pausar el clima durante el momento clave. En jardines y terrazas se puede lograr, pero el viento manda y hay que evaluarlo."
  - question: "¿Con qué se combina el humo bajo para que se vea mejor?"
    answer: "El humo bajo luce espectacular cuando un haz de luz lo corta. Un follow spot sobre los novios, un par LED de contraluz o las cabezas móviles del escenario hacen que la niebla brille y tome volumen. Sobre una pista de baile bien elegida y con iluminación de escenario detrás, el efecto pasa de bonito a memorable. Solo, en un piso oscuro, se aprovecha mucho menos."
draft: false
---
...
Llevamos más de tres décadas montando [efectos especiales de iluminación](/servicios/iluminacion/efectos-especiales/) en la Ciudad de México, y el humo bajo es de esos que todo el mundo ha visto en un video de boda y casi nadie sabe cómo se llama. Esta guía es lo que le explicamos a una pareja que nos dice "quiero el baile en las nubes": qué es, cómo funciona por dentro, por qué —a diferencia de la máquina de humo de toda la vida— **no dispara los detectores de humo del salón**, cuánto rinde y dónde te vas a equivocar. El precio lo tocamos de pasada —arranca **desde $800** para el efecto puntual del primer baile— y lo desglosamos a fondo, con tabla 2026 y casos reales, en el artículo hermano de [precios de humo bajo en CDMX](/blog/cuanto-cuesta-rentar-humo-bajo-cdmx-precios-2026/).
...
Te ponemos un montaje real de los que hacemos seguido. Boda de 140 invitados en un salón de la Roma. La pareja quería "esa nube" para su primer baile, sobre una [pista de baile](/servicios/pistas-baile/) blanca que ya tenían. Coordinamos con el DJ y con el capitán del salón para **pausar el aire acondicionado** treinta segundos antes y, cuando arrancó la canción, soltamos la carga: la niebla cubrió la pista en cinco segundos, los novios entraron a la nube y un [follow spot](/servicios/iluminacion/escenario/follow-spots/) los tomó desde el fondo. Tres minutos de efecto, una foto para toda la vida.
...
El otro factor es cuántas veces quieres el efecto. Si es solo el **primer baile**, una carga de hielo seco basta y sobra. Si quieres nublar **la entrada de los novios, el primer baile y el vals con los papás**, conviene el sistema con hielo, que repite sin problema. En [XV años](/servicios/iluminacion/escenario/) el patrón clásico es **vals con chambelanes** más **baile sorpresa**: dos momentos, dos disparos. En corporativos lo usamos para el *reveal* de un producto o la entrada de un directivo al escenario.
...
1. **No pausar el aire acondicionado.** Es el error número uno, por mucho. Una corriente de aire —el clima, un ventilador, una puerta abierta— barre la niebla en segundos y deshace el efecto. Por eso coordinamos con el venue para **pausar el clima** durante el minuto clave. Sin ese acuerdo, la mejor máquina del mundo no sirve.
2. **Esperar que la nube dure toda la canción... o toda la noche.** El hielo seco da dos a cuatro minutos por carga. Quien te promete una nube permanente con una sola carga te está vendiendo humo del otro. Se planea por momentos.
3. **Olvidar que el piso se pone resbaloso.** La niebla fría condensa humedad y enfría la superficie. En una pista pulida hay que cuidarlo: colocamos el punto de salida con criterio y avisamos a la pareja. Nunca soltamos una nube y nos vamos.
4. **No coordinar con el salón.** Aunque el humo bajo no dispare los detectores, hay que avisar. Algunos venues piden aviso por escrito, otros tienen reglas de sus sistemas contra incendios. Se pregunta antes, no el día del evento.
5. **Contratarlo sin luz que lo corte.** Una nube blanca sobre un piso a oscuras se pierde. El efecto vive cuando un haz de luz la atraviesa. Sin iluminación de escenario detrás, estás pagando la mitad del efecto. Lo vemos en la siguiente sección.
...
- **[Follow spots](/servicios/iluminacion/escenario/follow-spots/):** el seguidor sobre los novios, cortando la niebla desde el fondo, es la receta exacta del "baile en las nubes". Le da volumen a la nube y aísla a la pareja.
- **[Cabezas móviles / moving heads](/servicios/iluminacion/escenario/moving-heads/):** sus haces bajando sobre la niebla la encienden con color y movimiento. Para el momento fiesta, imbatible.
- **[Par LED de escenario](/servicios/iluminacion/escenario/par-led/):** como contraluz, hacen que la nube brille por detrás y se recorte contra el fondo oscuro.
- **[Pistas de baile](/servicios/pistas-baile/):** la nube se ve mejor sobre una pista clara, lisa y bien delimitada. Es el escenario natural del efecto.
- **[Confeti](/servicios/iluminacion/efectos-especiales/confeti/) y [mariposas de papel](/servicios/iluminacion/efectos-especiales/mariposas/):** para el clímax, el humo bajo abajo y el disparo de confeti o mariposas arriba arman una postal completa.
- **[Láser](/servicios/iluminacion/efectos-especiales/laser/) y [luz negra](/servicios/iluminacion/efectos-especiales/luz-negra/):** otros hermanos del hub de efectos para armar distintos momentos de la noche; el láser abanicando bajo sobre la niebla se ve brutal.

Para **producciones de gran escala** —conciertos, festivales, lanzamientos con niebla cubriendo toda la tarima y varios puntos de CO2 coordinados— trabajamos de la mano de aliados especializados como [REDEIL](https://rentadeiluminacion.com/), con más de 30 años y cientos de eventos, inventario Martin Professional, Chauvet y Elation, e instalación y operación incluidas. Cuando el proyecto pide músculo de esa liga, lo sumamos al nuestro.

Si quieres el panorama completo de cómo se arma un diseño de iluminación de principio a fin, léelo en la [guía maestra de iluminación para eventos](/blog/guia-iluminacion-eventos-arquitectonica-decorativa-escenario/); y para todo el equipo que hace falta en una producción, en la [guía completa de renta de equipo para eventos](/blog/eventech-renta-equipo-eventos-cdmx-guia-completa/).
...
La regla que te llevas: el humo bajo vive de dos cosas que no aparecen en la ficha del equipo —el operador que lo suelta en el segundo justo y la luz que lo atraviesa—. Por eso cada [efecto de humo bajo](/servicios/iluminacion/efectos-especiales/humo-bajo/) que montamos incluye evaluación del venue, coordinación con el salón, técnico y disparo en el instante exacto.

Cuando tengas claro qué momento quieres nublar, el siguiente paso es el número. Cuánto cuesta, qué incluye una cotización seria y qué paquete te toca lo desglosamos, con tabla de precios 2026 y casos reales, en el artículo hermano de [precios de humo bajo en CDMX](/blog/cuanto-cuesta-rentar-humo-bajo-cdmx-precios-2026/). Y si ya quieres tu propuesta con evaluación de pista, [cotiza aquí](/cotizar/) y la armamos contigo.
