---
title: "Sky Trackers para Eventos en CDMX: Guía Técnica Completa"
seoTitle: "Sky Trackers para Eventos CDMX: Guía Técnica"
...
tags:
  - sky tracker
  - reflectores de haz al cielo
  - iluminación de escenario
  - luces al cielo eventos
  - sky tracker bodas
  - iluminación eventos CDMX
  - haz de luz al cielo
  - producción de eventos
keywords:
  - sky tracker para eventos CDMX
  - renta de reflectores de haz CDMX
  - qué es un sky tracker
  - iluminación de haz al cielo bodas CDMX
  - sky tracker boda en jardín CDMX
  - reflector al cielo evento corporativo CDMX
  - cómo funciona un sky tracker
...
relatedEvents:
  ...
  - "xv-anos"
relatedPosts:
  - "cuanto-cuesta-rentar-sky-tracker-cdmx-precios-2026"
  - "guia-iluminacion-eventos-arquitectonica-decorativa-escenario"
  - "eventech-renta-equipo-eventos-cdmx-guia-completa"
cta:
  label: "Cotiza tu sky tracker el mismo día"
  href: "/servicios/iluminacion/escenario/sky-tracker/"
faqs:
  - question: "¿Qué es exactamente un sky tracker?"
    answer: "Es un reflector de haz de alta potencia, de 4,000 a 7,000 watts, con un cabezal rotatorio motorizado que proyecta una columna de luz concentrada hacia el cielo nocturno. Esa columna es visible a varios kilómetros y funciona como faro que marca la ubicación de tu evento. Se opera de forma fija, en barrido programado o en cruce entre varios equipos."
  - question: "¿Hasta dónde se ve el haz de un sky tracker?"
    answer: "En cielo despejado y noche cerrada, un equipo de 4,000 a 7,000W es visible entre 5 y 15 kilómetros. En la Ciudad de México, por la contaminación lumínica, lo realista es una visibilidad efectiva de varios kilómetros a la redonda. Entre más limpio y oscuro el entorno, más alto y definido sube el haz."
  - question: "¿Cuántos sky trackers necesito para mi evento?"
    answer: "Uno funciona como faro elegante para una boda íntima o un jardín. Dos crean haces cruzados sobre una hacienda o fachada. Cuatro forman un abanico en barrido para un corporativo o gala. Para festivales y conciertos se usan varios equipos sincronizados por DMX. La cantidad depende del efecto que buscas y del tamaño del venue."
  - question: "¿Un sky tracker sirve en interiores?"
    answer: "No. El sky tracker está pensado para proyectar al cielo abierto desde exterior o desde una terraza descubierta. En un salón techado no tiene sentido porque el haz choca con el techo. Para escenarios interiores se usan moving heads, follow spots o barras LED, que sí trabajan dentro del recinto."
  - question: "¿Necesito permisos para usar un sky tracker?"
    answer: "Para eventos estándar en salones, jardines y haciendas no se requiere permiso especial, porque la operación es nocturna, puntual y a baja inclinación. Cerca de aeropuertos o helipuertos se ajusta el ángulo de proyección por normativa aeronáutica, orientando el haz en barrido lateral en lugar de vertical directo. El técnico evalúa la ubicación en la visita previa."
  - question: "¿Con qué otros equipos de iluminación se combina?"
    answer: "El sky tracker marca el exterior; adentro se complementa con moving heads para la pista, follow spots para seguir a los protagonistas, gobos para proyectar nombres o logos y par LED para el ambiente general. Es la capa de gran escala de un diseño de iluminación completo, no un sustituto de las demás."
draft: false
---
...
Cada equipo consume una potencia considerable y opera con **corriente de 220V**, idealmente una toma **trifásica dedicada**. Aquí está el punto logístico que más sorpresas provoca: **muchos venues no tienen esa carga disponible**, sobre todo jardines, campos y haciendas. En esos casos se incluye una **planta de luz silenciosa** dimensionada al número de equipos, con combustible y operador. Si el venue no da la corriente y nadie te avisó de la planta, el día del evento te quedas sin haz. Por eso conviene resolver la energía desde la cotización y, si hace falta, sumar [plantas de energía](/servicios/accesorios/plantas-energia/) al pedido. En cuanto a intemperie, la carcasa es **IP54 sellada**, apta para rocío, humedad y lluvia ligera; ante tormenta eléctrica se suspende la operación, como con cualquier equipo de alta potencia.

Esta es la tabla que resume lo que de verdad debes mirar:

| Especificación | Rango real | Qué significa para tu evento |
|---|---|---|
| **Potencia** | 4,000W – 7,000W por equipo | Más watts, haz más alto y visible; el salto se nota de noche cerrada |
| **Alcance visual** | Hasta 15 km en cielo despejado | En CDMX, varios km efectivos por la luz de ciudad |
| **Ángulo del haz** | 1.5° – 3° (concentrado) | Sube como columna recta, no se abre ni se diluye |
| **Cabezal** | Rotatorio motorizado 360° | Fijo, en barrido o cruzado; programable |
| **Color** | Blanco puro o dicroico | Blanco = más alcance; color = combina con la paleta |
| **Alimentación** | 220V trifásico o planta de luz | Si el venue no da la carga, va planta silenciosa incluida |
| **Control** | DMX512 | Sincroniza varios equipos en secuencia |
| **Protección** | Carcasa sellada IP54 | Apta para exterior: rocío, humedad, lluvia ligera |
...
| Configuración | Efecto en el cielo | Dónde brilla |
|---|---|---|
| **1 equipo** | Faro vertical único, elegante | Boda íntima, jardín, terraza, XV años |
| **2 equipos** | Haces cruzados o en espejo | Hacienda, boda grande, fachada monumental |
| **4 equipos** | Abanico en barrido programado | Corporativo, gala nocturna, lanzamiento |
| **Varios sincronizados** | Show de cielo coreografiado por DMX | Festival, concierto, evento masivo |
...
1. **Contratarlo para un salón techado.** El sky tracker es de exterior. Si tu evento es en un salón cerrado, tu dinero rinde muchísimo más en [moving heads](/servicios/iluminacion/escenario/moving-heads/), [barras LED](/servicios/iluminacion/escenario/barras-led/) o [gobos](/servicios/iluminacion/escenario/gobos/). Reserva el sky tracker para donde hay cielo.
2. **Ignorar la energía.** El error logístico número uno. Si nadie revisó el cuadro eléctrico del venue, el día del evento descubres que no hay carga para 220V y el haz no enciende. Exige que la cotización especifique si se incluye [planta de energía](/servicios/accesorios/plantas-energia/).
...
Un error de concepto frecuente es pensar que el sky tracker "es" la iluminación del evento. No lo es: es la **capa de gran escala**, la que trabaja hacia afuera. Adentro, el diseño se construye con otras herramientas. Así se combina dentro del [hub de iluminación de escenario](/servicios/iluminacion/escenario/):

- **[Moving heads](/servicios/iluminacion/escenario/moving-heads/):** cabezas móviles que dan dinamismo sobre la pista y el escenario. Son el complemento natural del sky tracker: uno marca el cielo, los otros animan el piso.
- **[Follow spots](/servicios/iluminacion/escenario/follow-spots/):** el cañón seguidor que ilumina a los novios en su entrada o al orador en el escenario. Puntual y protagonista.
- **[Gobos](/servicios/iluminacion/escenario/gobos/):** proyectan nombres, iniciales, logos o texturas sobre muros y pistas. La firma personalizada del evento.
- **[Par LED](/servicios/iluminacion/escenario/par-led/) y [barras LED](/servicios/iluminacion/escenario/barras-led/):** el color y el ambiente general, la base que baña el espacio.
- **[Efectos especiales](/servicios/iluminacion/efectos-especiales/):** humo bajo, láser y confeti para los momentos clave.

Si quieres entender cómo encajan todas estas capas en un diseño coherente, lo desarrollamos en la [guía maestra de iluminación para eventos](/blog/guia-iluminacion-eventos-arquitectonica-decorativa-escenario/). Y si el evento es al aire libre, considera resguardar el equipo bajo [carpas profesionales](/servicios/carpas/): el sky tracker proyecta hacia el exterior sin problema mientras el resto de la producción queda protegida.
...
Recuerda que es una capa de exterior: brilla combinado con [moving heads](/servicios/iluminacion/escenario/moving-heads/), follow spots y gobos adentro, y pierde sentido en un salón techado. Si ya tienes claro qué quieres y ahora necesitas números, salta al artículo de [cuánto cuesta rentar un sky tracker en CDMX y sus paquetes 2026](/blog/cuanto-cuesta-rentar-sky-tracker-cdmx-precios-2026/). Y cuando quieras verlo aterrizado en tu venue, arma tu configuración en [sky trackers para eventos](/servicios/iluminacion/escenario/sky-tracker/) o [cotiza directo](/cotizar/) y te devolvemos la propuesta el mismo día, con la energía y el operador ya considerados.
